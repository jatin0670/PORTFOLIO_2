...
const Projects = () => {
  return (
    <div id='Projects' className=' w-full h-screen flex items-center justify-around pt-10 flex-col bg-red-600'>
      <h1 className='text-black text-3xl md:text-4xl font-bold '>My Projects</h1>
      <div className='h-4/5 p-2 gap-2 w-full flex flex-wrap items-center justify-center bg-yellow-500'>
