...
const ProjectCards = (props) => {
  return (
    <div className=' w-[75%] h-[45%] flex flex-col space-y-1 items-start justify-between overflow-hidden md:w-[60%] md:h-[45%] lg:w-[33%] lg:h-[75%] p-2 shadow-black shadow-md bg-[rgba(255,255,255,0.03)] rounded-lg'>
