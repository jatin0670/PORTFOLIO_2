...
const SkillCard = (props) => {
  return (
    <motion.div initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} className=' h-36 w-[50%] md:h-56 md:w-80 lg:h-64 lg:w-80 p-1 lg:p-2 flex flex-col items-center justify-center gap-2 md:justify-center md:gap-3 shadow-black shadow-md bg-[rgba(255,255,255,0.03)] rounded-lg
  '>
